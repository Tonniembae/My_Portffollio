      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
          <h2 className="uppercase tracking-widest text-center text-xs text-blue-100 max-w-80">
            DYNAMIC WEB MAGIC WITH TONNIE GRAPHICS AND DESIGN
          </h2>
          ...
          <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">
            Hi, I&apos;m Tonnie, a Full Stack Developer based in Kenya.
          </p>
          <div className='flex items-center justify-space-between gap-11'>
          <a href="#about">
